<%@ Page Title="" Language="C#" MasterPageFile="~/n_ter_base_loggedin_grid_wf.master" AutoEventWireup="true" CodeBehind="read_email_rules.aspx.cs" Inherits="N_Ter_Tasks.read_email_rules" %>

<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contTitle" runat="Server">
    N-Ter-Tasks > E-Mail Reading Rules
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contCSS" runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contHeader" runat="Server">
    E-Mail Reading Rules -
    ...
    <div class="panel panel-info" style="margin-top: -18px">
        <div class="panel-body">
            <div class="padding-xs-vr">
                <button id="cmdNew" runat="server" class="btn btn-labeled btn-primary"><span class="btn-label icon fa fa-plus"></span>New Email Rule</button>
        ...
        <div id="at_model_indent" class="at_modelpopup_indent">
            <div id="at_model_inner_indent" class="panel panel-inverse at_modelpopup_inner_indent">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">Add/Edit Email Rule</h4>
                </div>
                <div id="at_model_content" class="at_modelpopup_content styled-bar">
                    <div class="panel-body">
                        <div class="form-group">
                            <label>Mail Box to Look in</label>
                            <asp:DropDownList ID="cboMailBox" runat="server" CssClass="form-control"></asp:DropDownList>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="cboRule_Type_1" runat="server" CssClass="form-control">
                                                    <asp:ListItem Value="1">Sender E-Mail Address Contains</asp:ListItem>
                                                    <asp:ListItem Value="3">Sender E-Mail Address Starts With</asp:ListItem>
                                                    <asp:ListItem Value="2">E-Mail Title Contains</asp:ListItem>
                                                    <asp:ListItem Value="4">E-Mail Title Starts With</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td>
...
<asp:Content ID="Content5" ContentPlaceHolderID="contScripts" runat="Server">
    <script type="text/javascript">
        ...
        function ClearControls() {
            ...
            clearDropDown(['<%=cboMailBox.ClientID%>', '<%=cboEl2.ClientID%>', '<%=cboConditionType.ClientID%>', '<%=cboRule_Type_1.ClientID%>', '<%=cboRule_Type_2.ClientID%>', '<%=cboRule_Type_3.ClientID%>']);
            return false;
        }
        ...
        function LoadValauesPassed(result) {
            ...
            $('#<%=cboMailBox.ClientID%>').val(resultObject[0].Mail_Box_ID);
