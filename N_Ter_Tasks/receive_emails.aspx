<%@ Page Title="" Language="C#" MasterPageFile="~/n_ter_base_loggedin_grid.master" AutoEventWireup="true" CodeBehind="receive_emails.aspx.cs" Inherits="N_Ter_Tasks.receive_emails" %>

<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contTitle" runat="Server">
    N-Ter-Tasks > Force Receive Emails
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contCSS" runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contHeader" runat="Server">
    Force Receive Emails
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="contBody" runat="Server">
    <div class="panel panel-info">
        <div class="panel-body" style="padding-bottom: 0px">
            ...
            <div id="divSubmit" runat="server" style="padding-bottom: 20px">
                <button id="cmdReceive" class="btn btn-labeled btn-primary" onclick="return ReadEmails();"><span class="btn-label icon fa fa-envelope"></span>Read All Mail Boxes</button>
    ...
    <div class="panel panel-info">
        <div class="panel-body">
            <div class="panel-title-nter">Mail Boxes</div>
            <div class="border-t panel-info" style="height: 20px"></div>
            <div class="table-responsive table-primary no-margin-b">
                <asp:GridView ID="gvMain" runat="server" CssClass="table table-striped table-hover grid_table grid_mail_boxes non_full_width_table" data-size="non_full_width_table" AutoGenerateColumns="False">
                    <Columns>
    ...
    <div class="panel panel-info">
        <div class="panel-body">
            <div class="panel-title-nter">Email Rules</div>
            <div class="border-t panel-info" style="height: 20px"></div>
            <div class="table-responsive table-primary no-margin-b">
